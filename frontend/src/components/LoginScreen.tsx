            ...
            <form onSubmit={handleSubmit}>
              {provider === 'spotify' ? (
                <div className="text-center">
                  ...
                  <button
                    type="submit"
                    className="w-full bg-[#1db954] hover:bg-[#1ed760] text-white font-semibold py-3 px-6 rounded-xl transition-all haptic active:scale-[0.98] shadow-lg shadow-[#1db954]/25 flex items-center justify-center gap-2.5"
                  >
